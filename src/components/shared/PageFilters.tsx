...
export const PageFilters = () => {
    ...
    //TODO: сделать повление кнопки "сбросить фильтр" только после изменения фильтров, по умолчанию кнопки нет
    return (
      <div className="flex justify-between mb-8">
        <div className="flex flex-1 ">
            ...
            <Button onClick={reset} children='Сбросить фильтр' className='px-4 py-2 bg-[#282a2e] rounded-lg text-secondaryText'/>
